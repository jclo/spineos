...
# Modified for SpineOS by jclo <jclo@mobilabs.fr> (http://www.mobilabs.fr/)
# 
...
# $IPT -A bad_tcp_packets -p tcp -i $LOCAL_IFACE ! --syn \
...
$IPT -A FORWARD -i $INET_IFACE -m conntrack --ctstate ESTABLISHED,RELATED \
     -j ACCEPT
